...
shell_cmd commands[] = {
    ...
    /* mqtt + telnetd migrated to standalone netd-client tools
     * (pkg/net-cluster/tools): `run rom/mqtt pub|sub …`, `run rom/telnetd`.
     * telnetd presents the TCP connection as a vcon and spawns native_shell. */
};
